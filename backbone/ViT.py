...
class Attention(nn.Module):
    ...
    def forward(self, x):
        ...
        # permute: -> [3, batch_size, num_heads, num_patchs+1, embed_dim_per_head]
        qkv = self.qkv(x).reshape(B, N, 3, self.num_heads, C // self.num_heads).permute(2, 0, 3, 1, 4)
        # unbind(0): -> [batch_size, num_heads, num_patches+1, embed_dim_per_head]
...
class VisionTransformer(nn.Module):
    ...
    def __init__(
            ...
            prompt=None, embed_len_plus=0):
            # embedding_key='cls', prompt_init='uniform', prompt_pool=False, prompt_key=False, pool_size=None,
