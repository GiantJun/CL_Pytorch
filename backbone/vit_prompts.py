...
class CodaPrompt(nn.Module):
    def __init__(self, emb_d, n_tasks, prompt_pool, prompt_length, ortho_weight, key_dim=768):
        super().__init__()
        self.task_count = 0
        self.emb_d = emb_d
        self.key_d = key_dim
...
class DualPrompt(nn.Module):
    def __init__(self, emb_d, n_tasks, e_prompt_pool, e_prompt_length, g_prompt_length, key_dim=768):
        super().__init__()
        self.task_count = 0
        self.emb_d = emb_d
        self.key_d = key_dim
        self.n_tasks = n_tasks
        self._init_smart(emb_d, e_prompt_pool, e_prompt_length, g_prompt_length)
    ...
    def _init_smart(self, emb_d, e_prompt_pool, e_prompt_length, g_prompt_length):
...
class L2P(DualPrompt):
    def __init__(self, emb_d, n_tasks, prompt_pool, prompt_length, shallow_or_deep, key_dim=768):
        super().__init__(emb_d, n_tasks, prompt_pool, prompt_length, shallow_or_deep, key_dim)

    def _init_smart(self, emb_d, prompt_pool, prompt_length, shallow_or_deep):
        self.top_k = 5
